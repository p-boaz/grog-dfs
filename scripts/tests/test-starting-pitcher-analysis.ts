...
import {
  ...
  filterPitchersByExpectedStrikeouts,
  filterPitchersByWinProbability,
  sortPitchersByProjectedPoints,
} from "../../lib/mlb/dfs-analysis/pitchers/starting-pitcher-analysis";

// Setup logging
const LOG_FILE = path.join(
  __dirname,
  "../../logs/starting-pitcher-analysis-test.log"
);
fs.writeFileSync(
  LOG_FILE,
...
const sampleGames = [
  {
    ...
    lineups: {
      home: [
        553882, 665923, 667807, 474384, 547989, 663168, 619720, 623556, 672352,
      ],
      away: [
        592885, 596059, 543760, 592626, 592743, 665487, 543301, 607752, 621586,
      ],
    },
  },
  {
    ...
    lineups: {
      home: [
        572761, 425877, 543939, 641485, 547180, 607208, 669740, 675620, 608336,
      ],
      away: [
        605204, 493316, 624413, 431151, 605190, 643319, 656669, 594980, 453943,
      ],
    },
  },
];
