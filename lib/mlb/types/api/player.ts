...
export interface BatterApiResponse {
    id: number;
    fullName: string;
    team: string;
    position: string;
    ...
    careerByYear: Record<string, any>;
...
export interface PitcherApiResponse {
  id: number;
  fullName: string;
  currentTeam: string;
  primaryPosition: string;
...
export interface PitcherSeasonApiStats {
  2015: Record<string, any>;
  2016: Record<string, any>;
  2017: Record<string, any>;
  2018: Record<string, any>;
  2019: Record<string, any>;
  2021: Record<string, any>;
  2022: Record<string, any>;
  2023: Record<string, any>;
}